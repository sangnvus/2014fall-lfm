...
!function ($, moment) {
    ...
    DateRangePicker.prototype = {
        ...
        updateCalendars: function () {
            var lefthour = this.leftCalendar.month.hour();
            var leftmin = this.leftCalendar.month.minute();
            var righthour = this.rightCalendar.month.hour();
            var rightmin = this.rightCalendar.month.minute();
            if (typeof $('#datePickerEvent').data("daterangepicker") != "undefined") {
                lefthour = $('#datePickerEvent').data("daterangepicker").startDate.hour();
                leftmin = $('#datePickerEvent').data("daterangepicker").startDate.minute();
                righthour = $('#datePickerEvent').data("daterangepicker").endDate.hour();
                rightmin = $('#datePickerEvent').data("daterangepicker").endDate.minute();
            }

            this.leftCalendar.calendar = this.buildCalendar(this.leftCalendar.month.month(), this.leftCalendar.month.year(), lefthour, leftmin, 'left');
            this.rightCalendar.calendar = this.buildCalendar(this.rightCalendar.month.month(), this.rightCalendar.month.year(), righthour, rightmin, 'right');
